...
- `atlas/`
  - `DawnlikeAtlas0.png` — primary frames (3,853 sprites)
...
Renders every named sprite from `DawnlikeAtlas0.png` in its bin-packed 64×61 grid. Toggle animation to flip in `DawnlikeAtlas1.png` for the animated sprites; hover any cell to read its name from the atlas lookup. Use this to browse what's available before reaching for it by name.
