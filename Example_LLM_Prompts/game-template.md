...
- **Reference examples** — copy or mine the one(s) closest to your idea:
  ...
  - **Sewer / tunnel** → [`src/SewerExample.jsx`](https://github.com/lucas-stanford/dawnlike-atlas/blob/master/src/SewerExample.jsx) (central autotiled sludge channel, brick walkways on either side, crossing bridges, themed presets)
