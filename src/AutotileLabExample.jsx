...
const RESOLVERS = {
  ...
  shore: {
    ...
    backdrop: '#6dc3cb',
    note: 'Not original DawnLike art: the pack ships no coastline, so these are generated by scripts/generate-shore.mjs. A shore tile holds the whole land→water transition and is transparent where the water goes, so it composites over any water tile. This is a full 47-tile blob set — all 256 neighbourhoods collapse to 47, because a diagonal only matters when both its flanking cardinals are land. The variant sheet below shows the cardinal skeleton; toggle a diagonal in the pad to reach the corner-cut pieces.',
  },
  mountain: {
    label: 'Mountain blob',
